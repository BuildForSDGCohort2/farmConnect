...
class FirstTerm extends Component {
  componentDidMount() {
    ...
    this.props.firstTerm(this.props.match.params.student_id)
  ...
  render() {
    ...
    return (
      ...
      <h2 class="text-light display-6">{student.surname+' '+student.name} <span className='float-right'>1st Term Result </span></h2>
