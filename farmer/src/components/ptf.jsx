  ...
  render(){
    ...
    const Chats = (this.props.chats.loading===false)?((chats.length) ? (
            chats.map(chat => {
              return(
                <React.Fragment>
                <div class={(chat.sender_id===decode.school_id) ? "send-mess-wrap" : "recei-mess-wrap"}>
                        <div class={(chat.sender_id===decode.school_id) ? "send-mess__inner" : "recei-mess__inner"} >
                            <div class={(chat.sender_id===decode.school_id) ? "send-mess-list" : "recei-mess-list"}>
                                <div class={(chat.sender_id===decode.school_id) ? "send-mess" : "recei-mess"}>{chat.message}</div>
