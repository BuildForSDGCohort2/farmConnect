      ...
      news.map(news=>{
        return(
            (news.image!==('no image'||null||undefined))?(
              <article class="blog_item mb-1 mt-1">
                            ...
                            <aside class="single_sidebar_widget search_widget">
                                <form onSubmit={this.handleSubmit}>
                                {
                                  (this.state.image==='no image')?(
                                    ...
                                    <img id="image" alt='' src={kR} style={{width:'340px',height:'300px'}} className='mx-auto d-block img-thumbnail img-fluid' onClick={this.uploadFile}/>
                                    <input onChange={this.uploadImage} type="file" id="myfile" name='image' style={{display: "none"}}/>
                                    </div>
                                  ):(
                                    <img id="image" alt='' style={{width:'340px',height:'300px'}} src={this.state.image}  className='mx-auto d-block img-thumbnail img-fluid'/>
